...
const GlobalStyles = () => (
  <style>{`
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .no-drag, button, input, textarea, select { -webkit-app-region: no-drag; }
...
function Sidebar({ sessions, currentSessionId, onNewSession, onSelectSession, onOpenSettings }) {
  return (
    <aside className="drag-region" style={{
  ...
  return (
    <>
      ...
      <div style={{ display: 'flex', height: '100vh', overflow: 'hidden' }}>
        ...
        <main className="drag-region" style={{ flex: 1, display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden', background: 'var(--color-main-bg)' }}>
